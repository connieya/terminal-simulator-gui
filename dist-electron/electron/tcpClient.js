...
export class TcpClient {
    ...
    async sendCommand(command) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const useGuiJson = (command.type === "signon" || command.type === "sync" || command.type === "card_tap") &&
                hasTerminalId &&
    ...
    isTransactionSuccess(lines) {
        ...
        const hasSuccessKeyword = successKeywords.some((keyword) => fullText.toUpperCase().includes(keyword.toUpperCase()));
            ...
            if (line.trim()) {
                try {
                    ...
                    if (this.isResponseComplete(this.responseBuffer)) {
                        ...
                        const isTransactionSuccess = this.isTransactionSuccess(this.responseBuffer);
